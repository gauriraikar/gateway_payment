...
//make a string with | STEP1
$para_string="bank_ifsc_code=".$bank_ifsc_code."|bank_account_number=".$bank_account_number."|amount=".$amount."|merchant_transaction_ref=".$merchant_transaction_ref."|transaction_date=".$transaction_date."|payment_gateway_merchant_reference=".$payment_gateway_merchant_reference;
//sha conversion STEP2
...
//assuming that  received $para_string_sha_decoded64 from server;
...
$para_string_decoded="bank_ifsc_code=".$bank_ifsc_code_decoded."|bank_account_number=".$bank_account_number_decoded."|amount=".$amount_decoded."|merchant_transaction_ref=".$merchant_transaction_ref_decoded."|transaction_date=".$transaction_date_decoded."|payment_gateway_merchant_reference=".$payment_gateway_merchant_reference_decoded;
$hash_decoded_string =  sha1($para_string_decoded);
if( $hash_decoded_string= $hash_decoded)
{
	echo "the data verified successfully!!!!!!!<br>";
